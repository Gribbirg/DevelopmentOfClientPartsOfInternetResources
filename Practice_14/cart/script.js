...
function checkForNullCart() {
    if (cart.length === 0) {
        document.getElementById("cart_div").innerHTML = `<p>В корзине пусто!</p><a href="/DevelopmentOfClientPartsOfInternetResources/Practice_14/catalog/" class="arrow_button" id="to_catalog_href">Перейти в каталог<span></span></a>`;
        document.getElementById("clean_button").disabled = true;
    } else {
